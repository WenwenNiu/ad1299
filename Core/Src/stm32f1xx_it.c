...
void EXTI2_IRQHandler(void)
{
  /* USER CODE BEGIN EXTI2_IRQn 0 */
	...
	if(g_sample_status > 0)
	{
		/* ADS1299 ��ȡ����*/
		static float chx_val[8];
		ADS1299_ReadData(chx_val);
		
		// д������
		extern CircularBuffer ADS1299_circula_buffer;
		if (circular_buffer_write(&ADS1299_circula_buffer, (uint8_t *)chx_val, 8*4)) {
					//printf("����д��ɹ���\n");
			} else {
					//printf("����д��ʧ�ܣ�\n");
			}
  ...
  HAL_GPIO_EXTI_IRQHandler(ADS1299_DRDY_Pin);
...
void USART3_IRQHandler(void)
{
  /* USER CODE BEGIN USART3_IRQn 0 */
	...
	{ 
		...
		g_cmd_rx_len = CMD_RX_BUFFER_SIZE - temp;  //�ܼ�����ȥδ��������ݸ������õ��Ѿ����յ����ݸ���
		g_cmd_rx_done = 1;	// ������ɱ�־λ��1	
	}
